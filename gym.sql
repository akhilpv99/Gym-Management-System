...
INSERT INTO `address` (`id`, `streetName`, `state`, `city`, `pincode`) VALUES
('1622494379', 'KUNNUMMAL', 'KERALA', 'MALAPPURAM', '676505');
...
('admin1', '111111', 'admin1', 'DW FITNESS CENTRE');
...
(8, 'XODEWF', '1622494379', '2021-06-01', '2021-07-01', 'yes');
...
(6, NULL, NULL, NULL, NULL, NULL, '1622494379');
...
('XODEWF', 'Monthly Plan', 'A monthly subscription that unlocks the entire Gym Plan app and coach support on chat', '1', 800, 'yes');
...
('1622494379', 'IRSHAD C', 'Male', '9446784531', 'irshadc@gmail.com', '1998-11-25', '2021-06-01');
